  ...
  //  Menu lines
      void Display_item(int x)
      {
        switch (x)
        {
          ...
          //case ??: LCD.setCursor(0,Line);LCD.print(" Tusm. morgen  "); LCDprintDigits(hour(TodaysCivilTwilightMorning_t)); LCD.print(":"); LCDprintDigits(minute(TodaysCivilTwilightMorning_t));break;
          //case ??: LCD.setCursor(0,Line);LCD.print(" Tusm. aften   "); LCDprintDigits(hour(TodaysCivilTwilightEvening_t)); LCD.print(":"); LCDprintDigits(minute(TodaysCivilTwilightEvening_t));break;
          ...
          case 43: 
                   if (LightOnMorning_set == 0){
                   LCD.setCursor(0,Line);LCD.print(" Tid lys   ");LCDprintDigits(TimeWithLight_hour);LCD.print(":");LCDprintDigits(TimeWithLight_minute);break;}
                   if (LightOnMorning_set == 1){ 
                   LCD.setCursor(0,Line);LCD.print(" Lys t"); LCD.print(char(1)); LCD.print("nd  "); LCDprintDigits(LightOnMorning_hour); LCD.print(":"); LCDprintDigits(LightOnMorning_minute); break;}
                   else{
                   LCD.setCursor(0,Line);LCD.print(" ...            ");break;}
          case 44: LCD.setCursor(0,Line);LCD.print(" S");LCD.print("luk mode ");Display_mode_status(LightOffMorning_set);break;
          case 45: 
                   if (LightOffMorning_set == 0){
                   LCD.setCursor(0,Line);LCD.print(" Sluk solop.+"); LCD.print(":"); LCDprintDigits(LightOffDelayAfterSunRise_minute); break;}
                   if (LightOffMorning_set == 1){
                   LCD.setCursor(0,Line);LCD.print(" Lys sluk  "); LCDprintDigits(LightOffMorning_hour); LCD.print(":"); LCDprintDigits(LightOffMorning_minute); break;}
                   else{
                   LCD.setCursor(0,Line);LCD.print(" ...            ");break;}
          case 46: LCD.setCursor(0,Line);LCD.print(" V");LCD.write(3);LCD.print("gelys+    "); LCD.print(":"); LCDprintDigits(LightDimmerOnPrecedeLight_minute); break;
          ...
          case 53: 
                   if (LightOnEvening_set == 0) {
                   LCD.setCursor(0,Line);LCD.print(" Tid lys   ");LCDprintDigits(TimeWithLight_hour);LCD.print(":");LCDprintDigits(TimeWithLight_minute);break;}
                   if (LightOnEvening_set == 1) {
                   LCD.setCursor(0,Line);LCD.print(" Lys t"); LCD.print(char(1)); LCD.print("nd  "); LCDprintDigits(LightOnEvening_hour); LCD.print(":"); LCDprintDigits(LightOnEvening_minute); break;}
                   else {
                   LCD.setCursor(0,Line);LCD.print(" ...            ");break;}
          case 54: LCD.setCursor(0,Line);LCD.print(" S");LCD.print("luk mode ");Display_mode_status(LightOffEvening_set);break;
          case 55: 
                   if (LightOffEvening_set == 0) {
                   LCD.setCursor(0,Line);LCD.print(" T");LCD.print(char(1));LCD.print("nd soln.- "); LCD.print(":"); LCDprintDigits(LightOnPrecedeSunSet_minute); break;}
                   if (LightOffEvening_set == 1) {
                   LCD.setCursor(0,Line);LCD.print(" Lys sluk  "); LCDprintDigits(LightOffEvening_hour); LCD.print(":"); LCDprintDigits(LightOffEvening_minute); break;}
                   else {
                   LCD.setCursor(0,Line);LCD.print(" ...            ");break;}
          case 56: LCD.setCursor(0,Line);LCD.print(" V");LCD.write(3);LCD.print("gelys+    "); LCD.print(":"); LCDprintDigits(LightDimmerOffDelayAfterLight_minute); break;
          case 57: LCD.setCursor(0,Line);LCD.print(" EXIT MENU      ");break;
          ...
          case 63: 
                   if (DoorOpen_set == 0) {
                   LCD.setCursor(0,Line);LCD.print(" ");LCD.write(6);LCD.print("bn solopg.-"); LCD.print(":"); LCDprintDigits(DoorOpenPrecedeSunRise_minute); break;}
                   if (DoorOpen_set == 1) {
                   LCD.setCursor(0,Line);LCD.print(" D");LCD.print(char(2));LCD.print("r ");LCD.write(3);LCD.print("bn   "); LCDprintDigits(DoorOpen_hour); LCD.print(":"); LCDprintDigits(DoorOpen_minute); break;}
                   else {
                   LCD.setCursor(0,Line);LCD.print(" ...            ");break;}
          case 64: LCD.setCursor(0,Line);LCD.print(" Luk mode  ");Display_mode_status(DoorClose_set);break;
          case 65: 
                   if (DoorClose_set == 0) {
                   LCD.setCursor(0,Line);LCD.print(" Luk tusm");LCD.write(5);LCD.print("r.+"); LCD.print(":"); LCDprintDigits(DoorCloseDelayAfterCivilTwilight_minute); break;
                   }
                   if (DoorClose_set == 1) {
                   LCD.setCursor(0,Line);LCD.print(" D");LCD.print(char(2));LCD.print("r ");LCD.print("luk   "); LCDprintDigits(DoorClose_hour); LCD.print(":"); LCDprintDigits(DoorClose_minute); break;}
                   else {
                   LCD.setCursor(0,Line);LCD.print(" ...            ");break;}
          ...
          case 73: 
                   if (NestOpen_set == 0){
                   LCD.setCursor(0,Line);LCD.print(" ");LCD.write(6);LCD.print("bn tusm.-  ");LCD.print(":"); LCDprintDigits(NestOpenPrecedeCivilTwilight_minute); break;}
                   if (NestOpen_set == 1){
                   LCD.setCursor(0,Line);LCD.print(" Rede ");LCD.write(3);LCD.print("bn  "); LCDprintDigits(NestOpen_hour); LCD.print(":"); LCDprintDigits(NestOpen_minute); break;}
                   else {
                   LCD.setCursor(0,Line);LCD.print(" ...            ");break;}
          case 74: LCD.setCursor(0,Line);LCD.print(" Luk mode  ");Display_mode_status(NestClose_set);break;
          case 75: 
                   if (NestClose_set == 0){
                   LCD.setCursor(0,Line);LCD.print(" Luk solned.-"); LCD.print(":"); LCDprintDigits(NestClosePrecedeSunSet_minute); break;}
                   if (NestClose_set == 1){
                   LCD.setCursor(0,Line);LCD.print(" Rede ");;LCD.print("luk  "); LCDprintDigits(NestClose_hour); LCD.print(":"); LCDprintDigits(NestClose_minute); break;}
                   else {
                   LCD.setCursor(0,Line);LCD.print(" ...            ");break;}
